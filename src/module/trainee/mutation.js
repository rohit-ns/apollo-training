...
const Mutation = {
  createTrainee: async (parent, args, { dataSources, token }) => {
    try {
      ...
      pubsub.publish(TRAINEE_CREATE, { traineeCreate: result, token });
      return result;
    } catch (error) {
      return error;
    }
  ...
  updateTrainee: async (parent, args, { dataSources, token }) => {
    try {
      ...
      pubsub.publish(TRAINEE_UPDATE, { traineeUpdate: result, token });
      return result;
    } catch (error) {
      return error;
    }
  },
  deleteTrainee: async (parent, args, { dataSources, token }) => {
    try {
      const { input: { id } } = args;
      ...
      pubsub.publish(TRAINEE_DELETE, { traineeDelete: result, token });
      return result;
    } catch (error) {
      return error;
    }
